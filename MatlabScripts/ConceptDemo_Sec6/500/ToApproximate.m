...
load 'beta.mat'
load 'eigenvector_70'
model500 = load('ConceptDemo_500ms.mat');
...
mean500 = model500.model.B(4:19);  
temp_cov = getcov(model500.model);

[Con_V,Cov_D] = eig(temp_cov);                   
A = Con_V'; 
mean_translation = A*mean500';                            
...
% print('PDF_Conpdemo_500','-dtiff','-r800')